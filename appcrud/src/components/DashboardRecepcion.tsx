      ...
      <div className="bg-dark text-white p-3" style={{ width: "250px" }}>
        ...
        <ul className="nav flex-column">
          <li className="nav-item mb-2">
            <Link to="/listacliente2" className="nav-link text-white">
              Clientes
            </Link>
          </li>
          <li className="nav-item mb-2">
            <Link to="/listamoto2" className="nav-link text-white">
              Motocicletas
            </Link>
          </li>
          <li className="nav-item mb-2">
            <Link to="/listaservicio2" className="nav-link text-white">
              Servicios
            </Link>
          </li>
